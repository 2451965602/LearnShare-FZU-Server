...
-- ----------------------------
INSERT INTO
    `teachers` (`name`, `college_id`, `introduction`, `email`)
VALUES
    ('张教授', 1, '研究方向：分布式系统、操作系统。擅长理论与实践结合教学。', 'zhang.prof@fzu.edu.cn'),
    ('李教授', 1, '研究方向：机器学习、人工智能。指导过多个顶级算法竞赛团队。', 'li.prof@fzu.edu.cn'),
    ('王教授', 2, '研究方向：金融科技、量化投资。拥有丰富的业界经验。', 'wang.prof@fzu.edu.cn'),
    ('赵教授', 3, '研究方向：运筹学、数理统计。教学严谨，基础扎实。', 'zhao.prof@fzu.edu.cn');
...
VALUES
    (
        ...
        1,
        '大三',
        '深入理解操作系统原理，包括进程管理、内存管理、文件系统等核心概念'
    ),
    -- ID: 1
    (
        '深度学习',
        ...
        2,
        '研一',
        '神经网络与框架实战，涵盖CNN、RNN、Transformer等主流架构'
    ),
    -- ID: 2
...
VALUES
    ...
    (
        ...
        'https://file.example.com/option-pricing.docx',
        'docx',
        1536000,
        9,
        7,
...
VALUES
    (
        3,
        1,
        '张教授讲课非常清晰！理论与实践结合得很好，特别是进程同步的章节，收获很大。',
        NULL,
        15,
        'normal'
    ),
    ...
    (
        3,
        5,
        '李教授的数据库课程很实用，SQL优化部分特别有用',
        NULL,
        14,
        'normal'
    ),
    -- ID: 12
    (8, 5, '项目作业很有意思，设计了一个小型图书管理系统', 12, 8, 'normal'),
    -- ID: 13 (修正 parent_id)
    (
        8,
        7,
        '王教授的金融工程课程难度不小，但是内容很前沿',
        NULL,
        11,
        'normal'
    ),
    ...
    (
        4,
        10,
        '赵教授的高数课很扎实，基础概念讲得很清楚',
        NULL,
        16,
        'normal'
    ),
    -- ID: 16
    (5, 10, '课后习题有点多，但确实有助于理解概念', 16, 9, 'normal'),
    -- ID: 17 (修正 parent_id)
...
VALUES
    ...
    -- ID: 12
    (6, 7, '动态规划部分的模板特别好用，感谢分享', 12, 8),
    -- ID: 13 (修正 parent_id)
    (9, 7, '图论算法实现很规范，没有bug', 12, 7),
    -- ID: 14 (修正 parent_id)
    (3, 8, 'LeetCode题目解析很详细，思路清晰', NULL, 13),
    -- ID: 15
    (5, 8, '300道题目精选得很好，都是经典题型', 15, 10),
    -- ID: 16 (修正 parent_id)
    (8, 9, '量化策略回测系统很专业，学到了很多', NULL, 11),
    -- ID: 17
    (9, 9, '代码结构清晰，容易理解和修改', 17, 6),
    -- ID: 18 (修正 parent_id)
    (4, 11, '考研资料整理得很系统，知识点覆盖全面', NULL, 19),
    -- ID: 19
    (5, 11, '历年真题解析很详细，错误率应该不高', 19, 9),
    -- ID: 20 (修正 parent_id)
    (10, 11, '比市面上的一些考研资料要好很多', 19, 7),
    -- ID: 21 (修正 parent_id)
...
VALUES
    ...
    -- david: 学霸勋章
    (6, 13, 0),
    -- david: 森林绿昵称 (item_id:13)
    (7, 2, 1),
    -- emma: 金色头像框（使用中）
    (7, 4, 0),
    -- emma: 暗夜主题
    (7, 11, 0),
    -- emma: 火焰红昵称 (item_id:11)
    (8, 1, 0),
    -- frank: 彩虹头像框
    (8, 8, 1),
    -- frank: 分享达人勋章（使用中）
